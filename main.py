...
# bot_automation.create_server(templates="create_my_own", sec_op="for_me_and_friend", server_name="MobileLegends")
bot_automation.join_server(link_invite="https://discord.gg/nmBXsUY")
